...
import * as strings from 'SpReactListinfoWebPartStrings';
import SpReactListinfo from './components/SpReactListinfo';
import { ISpReactListinfoProps } from './components/ISpReactListinfoProps';
...
export interface ISpReactListinfoWebPartProps {
  description: string;
  listName: string;
}

export default class SpReactListinfoWebPart extends BaseClientSideWebPart<ISpReactListinfoWebPartProps> {

  public render(): void {
    const element: React.ReactElement<ISpReactListinfoProps > = React.createElement(
      SpReactListinfo,
      {
