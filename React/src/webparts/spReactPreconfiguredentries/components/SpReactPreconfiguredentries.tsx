...
import styles from './SpReactPreconfiguredentries.module.scss';
import { ISpReactPreconfiguredentriesProps } from './ISpReactPreconfiguredentriesProps';
import { escape } from '@microsoft/sp-lodash-subset';

export default class SpReactPreconfiguredentries extends React.Component<ISpReactPreconfiguredentriesProps, {}> {
  public render(): JSX.Element {
    if(this.needsConfiguration()) {
      ...
      return (
        <div className={styles.spReactPreconfiguredentries}>
  ...
  private needsConfiguration(): boolean {
    return SpReactPreconfiguredentries.isEmpty(this.props.listName) ||
      SpReactPreconfiguredentries.isEmpty(this.props.order) ||
      SpReactPreconfiguredentries.isEmpty(this.props.style);
  }
